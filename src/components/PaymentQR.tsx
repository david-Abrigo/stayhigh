...
import { Copy, Check, PlusCircle, ExternalLink, Radio, CheckCircle2, QrCode, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="max-w-lg mx-auto space-y-5">
      ...
      <div className="bg-white rounded-squircle-lg p-6 sm:p-9 shadow-[0_10px_35px_rgba(0,0,0,0.04)] border border-white/80 text-center transition-all">
        ...
        {!isMatched && (
          <div className="my-5 p-4 sm:p-5 rounded-2xl bg-brand-muted border border-brand-border text-left space-y-3.5">
